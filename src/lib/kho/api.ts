...
export function buildTheoryIngestPrompt(): string {
  return [
    ...
    'TÁCH mỗi ý/khối logic bằng MỘT DÒNG TRỐNG. Khối nào RÕ RÀNG thuộc 1 trong 7 loại sau thì thêm kí hiệu Ở ĐẦU DÒNG ĐẦU TIÊN của khối đó (có thể viết tiếp tiêu đề trên CÙNG dòng sau kí hiệu):',
    '  ##ĐN = Định nghĩa · ##ĐL = Định lý · ##TC = Tính chất hoặc Hệ quả · ##CY = Chú ý/Lưu ý · ##PP = Phương pháp giải/Quy tắc · ##VD = Ví dụ · ##NX = Nhận xét.',
...
export function buildLyThuyetPrompt(a: { tenDang: string; ghiChu?: string }): string {
  return [
    ...
    '- Khối nào RÕ RÀNG thuộc 1 trong 7 loại sau thì thêm kí hiệu Ở ĐẦU DÒNG ĐẦU TIÊN của khối đó (kí hiệu rồi có thể viết tiếp tiêu đề trên CÙNG dòng, vd "##ĐL Định lý 1 — Công thức nghiệm"):',
    '  ##ĐN = Định nghĩa · ##ĐL = Định lý · ##TC = Tính chất hoặc Hệ quả · ##CY = Chú ý/Lưu ý · ##PP = Phương pháp giải/Quy tắc · ##VD = Ví dụ · ##NX = Nhận xét.',
    '  Khối MƠ HỒ, không chắc thuộc loại nào ở trên → GIỮ NGUYÊN không gắn kí hiệu (không đoán bừa).',
