...
export function buildTheoryIngestPrompt(): string {
  return [
    ...
    'TÁCH mỗi ý/khối logic bằng MỘT DÒNG TRỐNG. Khối nào RÕ RÀNG thuộc 1 trong 7 loại sau thì thêm kí hiệu Ở ĐẦU DÒNG ĐẦU TIÊN của khối đó:',
    '  ##ĐN = Định nghĩa · ##ĐL = Định lý · ##TC = Tính chất, Hệ quả, hoặc mục tổng hợp "Kiến thức cần nhớ"/tóm tắt kiến thức · ##CY = Chú ý/Lưu ý · ##PP = Phương pháp giải/Quy tắc · ##VD = Ví dụ · ##NX = Nhận xét.',
...
export function buildLyThuyetPrompt(a: { tenDang: string; ghiChu?: string }): string {
  return [
    ...
    '- Khối nào RÕ RÀNG thuộc 1 trong 7 loại sau thì thêm kí hiệu Ở ĐẦU DÒNG ĐẦU TIÊN của khối đó:',
    '  ##ĐN = Định nghĩa · ##ĐL = Định lý · ##TC = Tính chất, Hệ quả, hoặc mục tổng hợp "Kiến thức cần nhớ"/tóm tắt kiến thức · ##CY = Chú ý/Lưu ý · ##PP = Phương pháp giải/Quy tắc · ##VD = Ví dụ · ##NX = Nhận xét.',
    '  Khối MƠ HỒ, không chắc thuộc loại nào ở trên → GIỮ NGUYÊN không gắn kí hiệu (không đoán bừa).',
    '  Tài liệu gốc đã có sẵn nhãn kiểu "Ví dụ 1.", "Định lý 2:", "Tính chất."… ở đầu khối → VIẾT NHÃN ĐÓ NGAY SAU kí hiệu, CÙNG 1 dòng (vd "##VD Ví dụ 1", "##ĐL Định lý 2"), rồi xuống dòng viết nội dung — KHÔNG lặp lại nhãn đó thêm 1 lần nữa ở đầu nội dung bên dưới.',
