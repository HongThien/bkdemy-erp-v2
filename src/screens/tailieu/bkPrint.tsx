...
.pv-bkh-pill{display:flex;flex-direction:column;padding:6px 11px;border:1.5px solid var(--line);border-radius:12px;color:var(--muted);font-size:10px;white-space:nowrap;line-height:1.3}
