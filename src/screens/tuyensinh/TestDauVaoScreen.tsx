...
type Tab = 'diem_danh' | 'cham' | 'tra_bai' | 'de' | 'phan_cong'
// ⭐ 13/09 (CEO): tab "Phân công" — bảng khối → người chấm → người trả bài; ca mới tự lấy từ đây (trigger DB).
const TABS: { v: Tab; lbl: string }[] = [
  { v: 'diem_danh', lbl: 'Điểm danh test' }, { v: 'cham', lbl: 'Chấm test' }, { v: 'tra_bai', lbl: 'Trả bài' }, { v: 'de', lbl: 'Đề test' }, { v: 'phan_cong', lbl: 'Phân công' },
]
      ...
      <div className="shrink-0 p-6 pb-0">
        <div className="mx-auto max-w-[1500px]">
          <div className="mb-4">
            ...
            <p className="text-[13px] text-slate-500">Đề test (sinh từ MT · Đề thi theo khối×môn) → Điểm danh (gán đề đang dùng) → Chấm Đ/C/S ∥ Scan bài đã chấm (Ops, việc riêng ở "Việc của tôi") → Trả bài (nhận xét + lớp đề xuất + phiếu)</p>
          </div>
