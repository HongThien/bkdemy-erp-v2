// Entry RIÊNG cho bundle PWA SỰ KIỆN (laptop check-in · điện thoại quản trò · TV) — không import ./App. Cùng 2 bài học từ main-hs/main-ta:
...
import AppSuKien from './AppSuKien'
import './index.css'
