...
- **CÒN:** KB3 (màn "Nhập tài liệu" cross-dạng + cột Dạng/câu người điền + route saveCauBatch theo dạng) · KB4 (lý thuyết: AI trả text + marker vị trí hình → chèn `![](url)` đúng chỗ). Rồi Phase 0 #1/#2/#3 trong cùng đợt.
