...
- **CÒN (Thùy đổi thứ tự → 2→4→3):** KB4 TIẾP THEO (lý thuyết: AI trả text + marker vị trí hình → chèn `![](url)` đúng chỗ, mở rộng nút "AI bóc" editor lý thuyết) · rồi KB3 (màn "Nhập tài liệu" cross-dạng + cột Dạng/câu người điền + route saveCauBatch theo dạng). Rồi Phase 0 #1/#2/#3 cùng đợt.
