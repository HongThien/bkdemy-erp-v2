...
const r = await c.query(`
  select thu_tu, left(noi_dung,40) noi_dung, lua_chon, dap_an_key from bai_test_cau
  where bai_test_id='7ca30d8b-6375-4304-826a-c585703b4885' and loai_cau='trac_nghiem' order by thu_tu
`)
