// Server tĩnh cho public/games (hub + game Trung Thu) để xem local — production là project Vercel bkdemy-games
// (Root Directory = public/games). Chạy: node scripts/serve-games.mjs [port]  (mặc định 5260)
