-- ============================================================================
-- 202608312039 — fn_dong_phase v5: NỚI guard cho INGAME (chấm bài trên lớp)
-- CEO 31/08 (sau khi app GV chạy thật): "chấm bài trên lớp không bắt buộc có dữ liệu —
-- TẠM THỜI cho phép đóng khi dữ liệu trống". ET/MT GIỮ NGUYÊN guard chặt của v4
-- (chưa chấm ô nào → chặn; ET/MT đòi FULL lưới HS×câu).
-- Thay đổi DUY NHẤT so với v4 (202608310120): khối GUARD ĐỦ DỮ LIỆU thêm điều kiện
-- `p_phase in ('et','mt')` — ingame bỏ qua cả 2 lớp guard. "Tạm thời": muốn siết lại
-- thì viết migration mới bỏ điều kiện này.
-- MẤT GÌ (Luật xoá): không — create or replace 1 function.
-- ============================================================================
...
begin
  ...
  -- ⛔ GUARD ĐỦ DỮ LIỆU (CEO 30/08) — v5: CHỈ còn áp cho ET/MT. Ingame miễn (CEO 31/08:
  -- chấm bài trên lớp không bắt buộc dữ liệu, cho đóng trống). Miễn sẵn có: buổi không đề ·
  -- ET online (máy chấm) · buổi bù/bổ trợ.
