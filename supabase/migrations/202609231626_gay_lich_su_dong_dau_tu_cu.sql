-- ============================================================================
-- fn_gay_lich_su — vá ngay sau khi áp 202609231619: LẦN ĐÓNG ĐẦU xảy ra TRƯỚC khi
-- có log thì suy từ cột `cu` của dòng log đầu tiên (mo_lai/doi_moc).
--
-- Ca thật bắt được ngay 23/09 16:22 (BTVN, TA Lộ Thị Dương): log chỉ có
--   mo_lai (cu = 13:15) → dong (16:22:48), hạn 16:00
-- Bản trước bỏ sót mốc 13:15 ⇒ timeline đọc thành "đóng 16:22 trễ 22 phút", trong
-- khi sự thật là "đóng 13:15 TRƯỚC HẠN, mở lại 16:22, đóng lại 16:22:48" — đúng
-- kiểu ca CEO cần phân biệt (nhân sự đóng muộn vs mở lại để điền bổ sung).
-- Chỉ thay thân hàm; bảng/trigger giữ nguyên.
-- ============================================================================
