-- ============================================================================
-- 202609122224 — fn_kho_duyet_menh_de_tra_ten_dang
-- ----------------------------------------------------------------------------
-- VÌ SAO: DuyetDungSaiTab vá mệnh đề TẠI CHỖ sau khi ký (CLAUDE.md §2 — không reload
--   list). DangPickerOne chỉ trả MÃ dạng ⇒ nếu RPC không trả tên, thẻ hiện mã trần
--   "T312010503" tới khi F5. Trả thêm ten_dang + ten_chuyen_de (join bản đồ) để UI có
--   tên thật ngay. Chỉ đổi phần RETURN của fn_kho_duyet_menh_de (mig 202609122218).
-- MẤT GÌ: không. Thay body 1 function.
-- ============================================================================
